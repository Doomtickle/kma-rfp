class ProposalRequestsController < ApplicationController
  ...
  private
    ...
    def proposal_request_params
      params.require(:proposal_request).permit(:client_name, :client_industry, :campaign_name, :basic_description, :flight_date_start, :flight_date_end, :staggered, :goals_and_objectives, :budget, :targeting1, :geography, :age_group, :gender, :household_income, :interests, :devices, :description, :creative_ad_units, :day_parting, :day_parting_description, :success_metrics, :specifications, :insertion_order_terms, :submission_instructions, :acceptable_proposal_formats, :proposal_due_date, :decision_made_by, :selection_criteria)
    end
end
